...
async function CardStatsWrapper (): Promise<React.JSX.Element> {
...
function StatsCards (props: StatsCardProps): React.JSX.Element {
  ...
  return <div className="w-full pt-8 gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
    ...
    <StatsCard
      ...
      helperText="Visitors that leave without interacting"
      value={data?.submissionRate.toLocaleString() + '%' || ''}
      loading={loading}
